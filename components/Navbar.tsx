...
import {
  Search, Sun, Landmark, PlusCircle, LayoutGrid, ChevronDown,
  ArrowRight, ArrowUpRight, Microscope, Route, Flower2, Ear, Send, Scale,
} from "lucide-react"
...
export default function Navbar() {
  ...
  return (
    <nav style={{ position: "sticky", top: 0, zIndex: 50, backgroundColor: "#ffffff" }}>
      <div style={{
        maxWidth: "1400px",
        margin: "0 auto",
        display: "flex",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "32px" }}>
          ...
          <Link href="/" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
            <svg width="124" height="26" viewBox="0 0 123 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            <NavLink href="/"              icon={<LayoutGrid size={15} />} label="Discover DTFs"    active={pathname === "/"} />
            <NavLink href="/gov-v2" icon={<Landmark size={15} />}  label="Participate & Earn" active={pathname.startsWith("/gov-v2")} />
            <NavLink href="/create"        icon={<PlusCircle size={15} />} label="Create New DTF"  active={pathname.startsWith("/create")} />
            <NavLink href="/gov-v1"        icon={<Scale size={15} />}      label="Governance v1"   active={pathname.startsWith("/gov-v1")} />
            ...
            >
              <button style={{
                ...
                color: moreOpen ? "#0151af" : "rgba(0,0,0,0.5)",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <IconBtn><Sun size={16} /></IconBtn>
          <button style={{
            padding: "8px 20px", borderRadius: "999px",
            background: "linear-gradient(135deg, #1a56db, #1e40af)",
            border: "none", color: "white",
            fontSize: "14px", fontFamily: FONT, fontWeight: 500,
...
function NavLink({ href, icon, label, active }: {
  ...
  return (
    <Link href={href} style={{
      ...
      padding: "6px 10px", borderRadius: "6px",
      background: "none",
      color: active ? "#0151af" : "rgba(0,0,0,0.5)",
      fontSize: "16px", fontFamily: FONT, fontWeight: active ? 500 : 300,
      textDecoration: "none",
    }}>
      {icon}
      {label}

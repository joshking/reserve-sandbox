...
import {
  ...
  Timer, CheckCircle2, ArrowRight, Target, PlusCircle, Lock,
} from "lucide-react"
...
const sidebarItems = [
  ...
  { id: "mint",        label: "Mint + Redeem",   Icon: Shuffle },
  { id: "governance",  label: "Governance",      Icon: Landmark },
  { id: "auctions",    label: "Auctions",        Icon: ArrowLeftRight },
  { id: "details",     label: "Details + Roles", Icon: Fingerprint },
]
...
function DtfSidebar({ active, onSelect }: { active: string; onSelect: (id: string) => void }) {
  return (
...
export default function DtfDetailPage({ params }: { params: { id: string } }) {
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#faf8f5" }}>
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", display: "flex" }}>
        ...
        <div style={{ width: 212, flexShrink: 0, position: "sticky", top: 0, height: "fit-content" }}>
          <DtfSidebar active={activeNav} onSelect={setActiveNav} />
        </div>
        ...
        <div style={{ flex: 1, display: "flex", gap: "8px", padding: "8px 8px 64px", minWidth: 0 }}>
          {activeNav === "governance" ? (
            <>
              {/* Governance — left: proposals */}
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "8px", minWidth: 0 }}>
                <div style={{ padding: "8px 0 4px" }}>
                  <Link href="/earn/index-dtf" style={{
